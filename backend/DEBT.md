...
| 把 total_cost_usd 當帳單管，沒讀真正的訂閱用量視窗 | 2026-08-20（Sam 指正） |
| 用換算值設「每日美金上限」，精確度是假的 | 2026-08-20（Sam 指正，直接移除） |
| **卡片描述從沒送進提示詞** —— open_cards 漏掉 description，且 Jira v3 回的是 ADF 不是字串 | 2026-08-20（DevLoop 對自己跑第一份規格時抓到的） |
